...
@php
    $path =  url("/Modules/Sales/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <div class="price">
                            <ins><span class="currency-type">{{super_currency_format_with_sym(ModulePriceByName($module->getName()) ['monthly_price'])}}</span><span class="time-lbl">{{__('/Month')}}</span></ins>
                            <ins><span class="currency-type">{{super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'])}}</span><span class="time-lbl">{{__('/Year')}}</span></ins>
                        </div>
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Salesy Makes It Super Easy For You To Manage Your Sales')}}</h2>
            ...
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        ...
                        <p>{{__('Salesy monitors your sales performance like a coach and lets you know whether you are on track. Get real time reports about every sales activity you make, make smarter decisions, and manage your business’s general sales more efficiently.')}} </p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Manage every aspect of your business sales from one place. Get sales updates on a daily, weekly or monthly basis. Monitor your sales, leads and accounts from a single comprehensive dashboard.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Access Your Clients’ Information')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Easily view and control the details of all your clients. Create user accounts and edit existing user information, manage your contacts, and do a lot more from anywhere - with a single tool.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage All Your Sales Management Tasks Quickly And Easily From One Place')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Control and keep track of your orders, invoices, and performance with ease. Easily track current trends, leads, and more. Schedule meetings, manage tasks, and carry out complex tasks in a few simple clicks.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Manage Your Sales From One Place')}}</h2>
                        </div>
                        <p>{{__('Access a wide range of easily customizable features in one place.Get an overview of your invoices, quotes and sales order- all under one roof.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Initially generated sales quotes can be altered, and updated as per the modification of the sales order on the particular sales quote.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Get paid for work done, fast. Integrate several payment options for diverse clients and make the payment process stress-free. Easily safeguard your clients’ payment by using Stripe, PayPal, Flutterwave, and more.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Get Instant Notifications')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Integrate the Twilio app and never miss an important notification again. Get notified when tasks or orders are completed and get notifications about meetings and new orders sent to your mobile phone via text.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        ...
                        <p>{{__('Modify and update your generated sales quotes with ease. Convert your quotes to invoices, get accurate information, and add new orders and products without stress.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Essential Information At Your Fingertips')}}</h2>
                        </div>
                        <p> {{__('Access a wide database of sales information under one tab. Easily filter through and sort details by different parameters. View invoices and orders, and manage information on a daily, weekly or monthly basis.')}}</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type"></span>{{super_currency_format_with_sym(ModulePriceByName($module->getName()) ['monthly_price'])}}<span
                                                    class="time-lbl">{{__('/Month')}}</span></ins>
                                        </div>
                                        <div class="lbl">{{__('Billed month, or')}} <b>{{super_currency_format_with_sym(ModulePriceByName($module->getName()) ['monthly_price'])}}{{__('/mo')}}</b>{{__(' if paid month')}}</div>
                                        <div class="btn-group">
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type"></span>{{ super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price']) }}<span
                                                    class="time-lbl">{{('/yearly')}}</span></ins>
                                        </div>
                                        <div class="lbl">{{__('Billed year, or ')}}<b>{{ super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price']) }}{{__('/mo')}}</b>{{__('if paid year')}}</div>
                                        <div class="btn-group">
                                            <a href="{{ route('apps.pricing') }}" class="btn-secondary">{{__('Buy Now')}}<svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    viewBox="0 0 16 16" fill="none">
