        ...
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td style="width: 60%;">
                            <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: var(--theme-color); color: {{$font_color}};">{{ __('Sales Order')}}</h3>
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number: ')}}</td>
                                        <td class="text-right">{{Modules\Sales\Entities\SalesOrder::salesorderNumberFormat($salesorder->salesorder_id,$salesorder->created_by,$salesorder->workspace)}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Issue Date:')}}</td>
                    ...
                    @if(isset($salesorder->items) && count($salesorder->items) > 0)
                        @foreach($salesorder->items as $key => $item)
                            <tr>
                                ...
                                <td>{{currency_format_with_sym($item->discount,$salesorder->created_by,$salesorder->workspace)}}</td>
