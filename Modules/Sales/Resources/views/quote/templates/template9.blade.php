...
<head>
    ...
    <title>{{Modules\Sales\Entities\Quote::quoteNumberFormat($quote->quote_id,$quote->created_by,$quote->workspace)}} | {{ !empty(company_setting('title_text',$quote->created_by,$quote->workspacey)) ? company_setting('title_text',$quote->created_by,$quote->workspacey) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'WorkDo') }}</title>
    <link
        ...
        <div class="invoice-header">
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td >
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: var(--theme-color); margin-bottom: 10px;">{{ __('Quote')}}</h3>
                        </td>
                        <td class="text-right">
