        ...
        <div class="invoice-header">
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        <td>
                            <h3 style="text-transform: uppercase; font-size: 25px; font-weight: bold; margin-bottom: 15px; color: {{$color}};">{{ __('Quote')}}</h3>
                            <table class="no-space">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ __('Issue Date:')}}</td>
                                        <td class="text-right">{{company_date_formate($quote->issue_date,$quote->created_by)}}</td>
                                    </tr>
