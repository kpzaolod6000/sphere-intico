...
@php
    $path = url("/Modules/ProjectTemplate/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('This powerful feature is designed to streamline your project management process by allowing you to create, save, and effortlessly convert project templates into active projects.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Elevate Your Project Management Experience')}}<b>{{__(' with ')}}</b>{{__('Our Project Template Module')}}</h2>
                <p>{{__('Our Project Template Module empowers you to create and convert project templates seamlessly, ensuring swift project setup and standardized workflows. Take your project management to the next level.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Easily Creating Templates')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Creating Templates')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('With this module, you can easily create project templates tailored to your specific needs.Also define project structures, tasks, milestones, and key parameters with this module.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Customization')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Take full advantage of customization options to make templates perfectly suited to your project requirements. Add, modify, or remove elements to craft the ideal template.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Converting Templates into Projects')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Saving Templates')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Once you`ve created your templates, you can save them for future use. Give them meaningful names and organize them for quick access.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Organizing Templates')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Keep your templates neatly organized with category and tagging options. This ensures you can quickly locate the right template when needed.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Using Templates & Modifications')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('When it`s time to start a new project, simply select a saved template. Your project will be initiated based on the template`s structure and parameters.Need to make changes on the fly? No problem! You can easily tweak your project during creation, adding or removing elements as necessary.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Project Template Benefits')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Efficiency & Consistency')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Save valuable time and reduce manual data entry. Use templates to kickstart your projects instantly.Templates ensure that every project follows a consistent structure and maintains standardized information, reducing errors.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Optimizing Templates')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Discover best practices for creating efficient and effective templates, ensuring your templates work for you.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
