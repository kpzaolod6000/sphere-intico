...
@php
    $path = url('/Modules/SideMenuBuilder/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="row row-gap align-items-center pdp-summery-row">
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            ...
                            <p>{{ __('Side menu builder are often used to provide a tailored and user-friendly experience by allowing users to access specific content or perform actions with a single click. Design a user-friendly form where users can input their Side Menu Builder details, such as the destination URL, link alias, and any additional parameters.') }}
                            </p>
                            <div class="price">
                                <ins><span
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Get ') }}<b>{{ __('Additional ') }}</b>{{ __(' Information for a Side Menu Builder') }}
                    </h2>
                    <p>{{ __('Tailor and design user-friendly side menus for your applications with our Side Menu Builder') }}
                    </p>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('Manage Side Menu Builder') }}</h2>
                            </div>
                            <p>{{ __('You can create a module in the sidebar by simply clicking the Create button. In which you can manage the module and also edit that module according to your own. And you can also delete that module.') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('what is the purpose of Side Menu Builder?') }}</h2>
                            </div>
                            <p>{{ __('Side Menu Builder allows you to guide users directly to particular web pages, content, or actions within a website or application. Instead of relying on standard or generic links, Side Menu Builder provides a more direct and relevant path to information or functionality.') }}
                            </p>
                        </div>
                    </div>
                </div>
