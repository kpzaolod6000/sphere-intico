...
{{ Form::model($contract, array('route' => array('contract.update', $contract->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
    ...
    <div class="row">
        ...
        @if(module_is_active('Taskly'))
            <div class="col-md-6 form-group">
                ...
                {{ Form::select('project_id',$project,null, array('class' => 'form-control','id'=>'project_id','placeholder' => 'Select Project')) }}
            </div>
        @endif
        <div class="col-md-6 form-group">
