                    ...
                    <div class="row invoice-title mt-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                            <h3 class="invoice-number">
                                {{ \Modules\Contract\Entities\Contract::contractNumberFormat($contract->id, $contract->created_by, $contract->workspace) }}
                            </h3>
                        </div>
                    </div>
...
@endsection
@push('scripts')
    <script src="{{ asset('Modules/Contract/Resources/assets/js/html2pdf.bundle.min.js') }}"></script>
    <script>
        ...
        $(window).on('load', function() {
            ...
            var opt = {
                filename: '{{ Modules\Contract\Entities\Contract::contractNumberFormat($contract->contract_id, $contract->created_by, $contract->workspace) }}',
                image: {
                    type: 'jpeg',
                    quality: 1
                },
